...
load_dotenv(dotenv_path='booking_api_django_new/environments/' + os.environ.get('BRANCH', default='prod_gpn') + '.env')
...
ACCESS_TOKEN_LIFETIME = timedelta(days=7) if DEBUG else timedelta(days=7)
