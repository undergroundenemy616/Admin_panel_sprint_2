    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_info', django.contrib.postgres.fields.hstore.HStoreField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entrance', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
