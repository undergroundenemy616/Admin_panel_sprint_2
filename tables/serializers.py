...
class TestTableSerializer(serializers.Serializer):
    ...
    tags = serializers.PrimaryKeyRelatedField(read_only=True, required=False, many=True)
    images = serializers.PrimaryKeyRelatedField(read_only=True, required=False, many=True)
    rating = serializers.ReadOnlyField()
...
class UpdateTableSerializer(CreateTableSerializer):
    ...
    title = serializers.CharField(required=False)
    tags = serializers.PrimaryKeyRelatedField(queryset=TableTag.objects.all(), required=False, many=True, allow_null=True)
    images = serializers.ListField(child=serializers.PrimaryKeyRelatedField(queryset=File.objects.all()),
                                   write_only=True, allow_empty=True, required=False)
...
class TestTableMarkerSerializer(serializers.Serializer):
    id = serializers.UUIDField()
